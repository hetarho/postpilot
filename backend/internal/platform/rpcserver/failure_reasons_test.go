...
var publicFailureReasons = []string{
	...
	"CLIP_FACTS_REQUIRED",
	"CLIP_SOURCE_UNAVAILABLE", "CLIP_PREVIEW_BUSY", "CLIP_PREVIEW_TIMEOUT", "CLIP_PREVIEW_TOO_LARGE", "CLIP_PREVIEW_UNAVAILABLE", "CLIP_SOURCE_EXPIRED", "CLIP_SOURCE_MISSING",
	"CLIP_NOT_FOUND",
