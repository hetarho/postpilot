...
func TestLanguageAwarePromptsKeepKoreanBaselineAndDefendPortableProjection(t *testing.T) {
	...
	english, _ := BuildWritePromptForLanguage(LanguageEnglish, leaky, nil, "memo", "title", nil, nil, nil, 4, nil, nil)
	...
	korean, _ := BuildWritePromptForLanguage(LanguageKorean, Profile{}, nil, "", "", nil, nil, nil, 4, nil, nil)
