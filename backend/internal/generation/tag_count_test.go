...
func TestPromptsAskForExactlyTheFrozenTagCount(t *testing.T) {
	writeKo, _ := BuildWritePromptForLanguage(LanguageKorean, goldenProfile(), nil, "memo", "title", nil, nil, nil, 7, nil, nil, nil, nil)
	writeEn, _ := BuildWritePromptForLanguage(LanguageEnglish, goldenProfile(), nil, "memo", "title", nil, nil, nil, 7, nil, nil, nil, nil)
