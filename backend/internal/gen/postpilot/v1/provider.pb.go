...
func (x *ModelInfo) GetSignedVideoUrl() bool {
	if x != nil {
		return x.SignedVideoUrl
	}
	return false
}

func (x *ModelInfo) GetInlineStaticVideo() bool {
	if x != nil {
		return x.InlineStaticVideo
	}
	return false
}
...
func (x *ModelInfo) GetLevels() []*StageLevel {
	if x != nil {
		return x.Levels
	}
	return nil
...
func (x *StageLevel) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *StageLevel) GetLevel() string {
	if x != nil {
		return x.Level
	}
	return ""
...
const file_postpilot_v1_provider_proto_rawDesc = "" +
	...
	"videoInput\x12(\n" +
	"\x10signed_video_url\x18\x11 \x01(\bR\x0esignedVideoUrl\x12.\n" +
