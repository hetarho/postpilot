...
func BuildPlanPrompt(in clip.PlanningInput, fadeMS int) (string, string) {
	...
	return system, promptJSON(map[string]any{
		"template": map[string]any{"name": in.Template.Name, "information_fields": fields, "cut_guidance": in.Template.CutGuidance, "caption_pace": in.Template.CaptionPace, "accent": in.Template.Accent},
