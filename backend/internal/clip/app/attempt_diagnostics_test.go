...
func TestAttemptDiagnosticsLogOnlyOwnedBoundedMetadata(t *testing.T) {
	...
	logAttemptDiagnostic("job", "plan", clip.AttemptDiagnostic{Check: "private-response", Phase: "private-filename", Values: map[string]int{"target_ms": 30000, "cut": 2, "private-signed-url": 1, "after_ms": -1}})
	text := out.String()
