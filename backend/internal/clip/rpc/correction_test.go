...
func TestCorrectionWireRoundtripAndConflict(t *testing.T) {
	s := &clip.CorrectionState{Plan: clip.CorrectionPlan{DurationMS: 15000, Cuts: []clip.CorrectionCut{{ID: "cut", SourceID: "source", Fingerprint: "fingerprint", StartMS: 500, EndMS: 15500, VolumePermille: 123, Copy: clip.Caption{Text: "정확한 <한글>", Anchor: "lower_mid", Align: "center", Style: "memo", Accent: "teal", StartMS: 200, EndMS: 3000}}}}, Sources: []clip.AnalysisSource{{RenderSource: clip.RenderSource{ID: "source", Fingerprint: "fingerprint", Info: clip.MediaInfo{DurationMS: 30000, Width: 1920, Height: 1080}}, Filename: "travel.mp4"}}, CopyStyles: []string{"clean", "memo"}, FadeMS: 200, MaxCuts: 100, MaxCopyRunes: 500, MinDurationMS: 15000, MaxDurationMS: 90000}
	wire := editingProto(s)
