...
func (s *nativeRPCStore) GetProject(_ context.Context, user, id string) (clip.Project, error) {
	...
	return clip.Project{ID: id, UserID: user, Composition: &clip.ProjectComposition{Snapshot: clip.CompositionSnapshot{Version: 1, Body: `<clip version="1"><field id="a" label="同名"/><field id="b" label="同名"/><text id="empty-hook" kind="fixed" role="hook"/><text id="empty-ending" kind="fixed" role="ending"/></clip>`}, Inputs: clip.CompositionInputs{Values: map[string]string{"a": "old"}}}}, nil
}
