...
func TestStylesMotionTimingTransitionAudioAndLuma(t *testing.T) {
	...
	if design.Timing != (design.TimingTokens{SubMinBaseMS: 900, SubMinPerCharMS: 90, CutMinS: 1.2, CutMaxS: 6, HookCardS: 1.5, EndCardS: 2.5, BadgeMinHeadS: 3, BadgeMinTailS: 3}) {
