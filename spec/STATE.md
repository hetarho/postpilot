...
|---|---|---|---|---|
| T401 | Region presets stack by gaps and fit their width (A, B, outro B, E) | CDS CLIP | - | todo |
...
## next
- implement-task T401 → T402 → T403 → T404 → T405 (CDS r26, CLIP r45 region preset overhaul), one commit each
