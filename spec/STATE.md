...
|---|---|---|---|---|
| ARCH | 2 | 2 | - | 0 |
| AUTH | 4 | 3 | AUTH-30✎ AUTH-42+ AUTH-43+ | 1 |
| QUOTA | 6 | 6 | - | 0 |
| POST | 3 | 3 | - | 0 |
| VOICE | 1 | 1 | - | 1 |
| GEN | 4 | 4 | - | 0 |
...
## next
- create-task AUTH (r4: AUTH-30✎ 42+ 43+ — the titled login/signup screens and the Google rollout: OAuth client + `GOOGLE_CLIENT_ID/SECRET` on the VPS .env + `VITE_GOOGLE_CLIENT_ID` in the Cloudflare build); AUTH-45 [?] (signed-out free-tier use) waits on the owner — a [o] answer ripples into QUOTA-1 · 9, AUTH-16 · 34, BILLING-10 and MARKETING-6 · 16, so it goes through update-ssot AUTH QUOTA before any task
