...
| T167 | Render the intro and outro presets instead of the hook and ending cards | CDS CLIP | T166 | doing@260915.dsg |
...
## next
- Finish T167 (dsg), then T169; T166 tokens and T170 font validation are complete.
