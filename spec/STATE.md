...
|---|---|---|---|---|
| T402 | The writer, its repair and answer limits bound region rows by width | CDS CLIP | - | todo |
| T403 | Six intro and five outro presets with their neutral decoration and the region scrim | CDS | - | todo |
...
## next
- implement-task T402 → T403 → T404 → T405 (CDS r26, CLIP r45 region preset overhaul), one commit each
