...
| T110 | Release QA on the Naver app and the overlay measurement | CDS CLIP | T108 | doing@260912.trs |
...
- implement-task T110 next — it needs the owner with the Naver app and closes CDS-11. T111 → T112 are independent of this chain
