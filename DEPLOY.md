...
2026-09-25 `e933ea73`의 [실제 배포 실행](https://github.com/hetarho/postpilot/actions/runs/36108695737)은
생성부터 완료까지 **3분 21초**였다(이미지 빌드 작업 2분 23초, 서버 배포 작업 50초).
완료 후 별도 영상 검증의 세 작업이 병렬로 시작됐고, 외부 API `/health`도 정상 응답했다.
