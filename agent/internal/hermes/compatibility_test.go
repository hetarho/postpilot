...
func TestCompatibilityRequiresCapabilitiesRatherThanExactVersion(t *testing.T) {
	manifest := []byte(`{"checked_at":"2026-09-01","latest_checked_release":"0.20.6","required_commands":["doctor"],"required_plugin_hooks":["pre_tool_call"],"allowed_browser_hosts":["blog.naver.com"]}`)
