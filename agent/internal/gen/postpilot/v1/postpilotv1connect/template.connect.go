...
const (
	...
	TemplateServiceName = "postpilot.v1.TemplateService"
)
...
const (
	...
	// ListTemplates RPC.
	TemplateServiceListTemplatesProcedure = "/postpilot.v1.TemplateService/ListTemplates"
	// TemplateServiceCreateTemplateProcedure is the fully-qualified name of the TemplateService's
	// CreateTemplate RPC.
	TemplateServiceCreateTemplateProcedure = "/postpilot.v1.TemplateService/CreateTemplate"
	// TemplateServiceUpdateTemplateProcedure is the fully-qualified name of the TemplateService's
	// UpdateTemplate RPC.
	TemplateServiceUpdateTemplateProcedure = "/postpilot.v1.TemplateService/UpdateTemplate"
...
func NewTemplateServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TemplateServiceClient {
	...
	templateServiceMethods := v1.File_postpilot_v1_template_proto.Services().ByName("TemplateService").Methods()
...
// CreateTemplate calls postpilot.v1.TemplateService.CreateTemplate.
...
// UpdateTemplate calls postpilot.v1.TemplateService.UpdateTemplate.
...
// DeleteTemplate calls postpilot.v1.TemplateService.DeleteTemplate.
...
func (UnimplementedTemplateServiceHandler) ListTemplates(context.Context, *connect.Request[v1.ListTemplatesRequest]) (*connect.Response[v1.ListTemplatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("postpilot.v1.TemplateService.ListTemplates is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) CreateTemplate(context.Context, *connect.Request[v1.CreateTemplateRequest]) (*connect.Response[v1.CreateTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("postpilot.v1.TemplateService.CreateTemplate is not implemented"))
}
...
func (UnimplementedTemplateServiceHandler) UpdateTemplate(context.Context, *connect.Request[v1.UpdateTemplateRequest]) (*connect.Response[v1.UpdateTemplateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("postpilot.v1.TemplateService.UpdateTemplate is not implemented"))
}
