...
const (
	...
	HealthServiceName = "postpilot.v1.HealthService"
)
...
const (
	...
	HealthServicePingProcedure = "/postpilot.v1.HealthService/Ping"
)

// HealthServiceClient is a client for the postpilot.v1.HealthService service.
type HealthServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewHealthServiceClient constructs a client for the postpilot.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_postpilot_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Ping calls postpilot.v1.HealthService.Ping.
...
// HealthServiceHandler is an implementation of the postpilot.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/postpilot.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("postpilot.v1.HealthService.Ping is not implemented"))
}
