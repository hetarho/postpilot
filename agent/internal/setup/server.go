...
<style>body{font-family:-apple-system,sans-serif;max-width:640px;margin:auto;padding:32px 16px;background:#17151a;color:#f7f2f8}label{display:block;margin-top:16px}input:not([type=checkbox]),select,button{box-sizing:border-box;width:100%;min-height:44px;margin-top:6px;padding:10px 14px;border:0;border-radius:10px;font-size:16px}input:not([type=checkbox]),select{background:#29252d;color:#fff}button{background:#8b5cf6;color:#fff;font-weight:600}.secondary{background:#39333e}.message{padding:12px;margin:16px 0;border-radius:10px;background:#193a2b}.error{padding:12px;margin:16px 0;border-radius:10px;background:#48252b}.check{display:flex;gap:10px;align-items:center}.check input{flex:none;width:20px;height:20px;min-height:0;margin:0;accent-color:#8b5cf6}.check span{padding-top:0}.card{padding:14px;margin:10px 0;border-radius:10px;background:#29252d}.card p{margin:0 0 8px}.card input:not([type=checkbox]){background:#1f1b24;border:1px solid #4a4450}</style>
