...
export const i18n = {
  ...
  ko: {
    ...
    notices: {
      ...
      introSlotShortened: '인트로 문구를 자리에 들어가는 짧은 표현으로 담았어요.',
      outroSlotShortened: '아웃트로 문구를 자리에 들어가는 짧은 표현으로 담았어요.',
      introSlotOmitted: '인트로 자리에 담기 어려운 AI 문구를 뺐어요.',
      outroSlotOmitted: '아웃트로 자리에 담기 어려운 AI 문구를 뺐어요.',
  ...
  en: {
    ...
    notices: {
      ...
      introSlotShortened: 'The intro uses a shorter phrase that fits its place.',
      outroSlotShortened: 'The outro uses a shorter phrase that fits its place.',
      introSlotOmitted: 'An AI phrase too long for its place was left out of the intro.',
      outroSlotOmitted: 'An AI phrase too long for its place was left out of the outro.',
      contrastReview:
