...
import { toClipEditingState } from '@/entities/clip-plan/@x/clip-project'
import { toClipAccounting } from './credits'
import { toClipObservations } from '@/entities/clip-observation/@x/clip-project'
import { toClipAttemptInspection } from '@/entities/clip-observation/@x/clip-project'
import { isClipRequestKind, type ClipProjectRequest } from '@/entities/clip-plan/@x/clip-project'
