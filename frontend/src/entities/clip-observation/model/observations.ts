...
} from '@/entities/clip-plan/@x/clip-observation'
...
/** What one generation attempt recorded about its own observation pass: the same evidence the
 *  viewer shows, plus the stage counters an inspection reads (CLIP-51). It is the observation
 *  noun's, not the project's — the project only carries the latest one. */
