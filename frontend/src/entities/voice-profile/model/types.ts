...
export interface StructuredVoiceProfile {
  ...
  axes: { involvement: number; narrativity: number; persuasionOvertness: number; abstractness: number; addresseeFocus: number; humor: number }
