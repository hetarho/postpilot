  ...
  ko: {
    composition: {
      design: {
        ...
        intro_serif: '명조 매거진',
        intro_frame: '프레임 박스',
        intro_outline: '큰 외곽선 글자',
        intro_lower: '로어서드',
        intro_sticker: '주아 스티커',
        caption_bold: '크게 강조',
        outro_b: 'B 가로선 구분',
        outro_e: 'E 점수 강조',
        outro_credits: '엔딩 크레딧',
        outro_sidebar: '세로 막대 로어서드',
        outro_chips: '칩 줄',
        outro_list: '세 줄 목록',
        outro_stamp: '원형 도장',
        /** What each slot of a preset drawing says; `{n}` is the slot's outline number,
         *  filled in by the renderer (CLIP-165). */
        slotLabel: '슬롯 {n}',
        slotsHelp:
  ...
  en: {
    composition: {
      design: {
        ...
        intro_cover: 'Magazine cover',
        intro_serif: 'Serif magazine',
        intro_frame: 'Frame box',
        intro_outline: 'Large outline type',
        intro_lower: 'Lower third',
        intro_sticker: 'Jua sticker',
        caption_bold: 'Large emphasis',
        outro_b: 'B Divider line',
        outro_e: 'E Score emphasis',
        outro_credits: 'End credits',
        outro_sidebar: 'Side bar lower third',
        outro_chips: 'Chip row',
        outro_list: 'Three-line list',
        outro_stamp: 'Round stamp',
        slotLabel: 'Slot {n}',
        slotsHelp:
