...
export const errors = {
  ...
  VOUCHER_INVALID: '이용권 발급 내용을 다시 확인해 주세요.',
  VOUCHER_NOT_FOUND: '이용권을 찾을 수 없어요. 링크를 다시 확인해 주세요.',
  VOUCHER_REDEEMED: '이미 받은 이용권이에요.',
  VOUCHER_EXPIRED: '받을 수 있는 기간이 지난 이용권이에요.',
  VOUCHER_REVOKED: '취소된 이용권이에요.',
  ...
  CLIP_MEDIA_RETRY_EXHAUSTED:
    '영상 처리를 여러 번 시도했지만 완료하지 못했습니다. 잠시 후 다시 시도하세요. 완료된 분석과 이전 결과는 유지됩니다.',
  CLIP_MEDIA_TIMEOUT:
    '영상 처리 제한 시간을 초과했습니다. 잠시 후 다시 시도하세요. 완료된 분석과 이전 결과는 유지됩니다.',
