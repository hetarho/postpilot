 ...
 *
 * @generated from enum postpilot.v1.ModelPurpose
 */
export enum ModelPurpose {
  /**
   * @generated from enum value: MODEL_PURPOSE_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,

  /**
   * @generated from enum value: MODEL_PURPOSE_PHOTO_ANALYSIS = 1;
   */
  PHOTO_ANALYSIS = 1,

  /**
   * @generated from enum value: MODEL_PURPOSE_STYLE_ANALYSIS = 2;
   */
  STYLE_ANALYSIS = 2,

  /**
   * @generated from enum value: MODEL_PURPOSE_WRITING = 3;
   */
  WRITING = 3,

  /**
   * @generated from enum value: MODEL_PURPOSE_IMAGE_GENERATION = 4;
   */
  IMAGE_GENERATION = 4,

  /**
   * @generated from enum value: MODEL_PURPOSE_VIDEO_GENERATION = 5;
   */
  VIDEO_GENERATION = 5,
}

/**
 * Describes the enum postpilot.v1.ModelPurpose.
 */
export const ModelPurposeSchema: GenEnum<ModelPurpose> = /*@__PURE__*/
