...
export type ModelInfo = Message<"postpilot.v1.ModelInfo"> & {
   ...
   * (MODEL-57). A picker shows its own stage's level and orders by it, 가성비 first; a stage
   ...
   *
   * @generated from field: repeated postpilot.v1.StageLevel levels = 19;
   */
  levels: StageLevel[];
};
 ...
 *
 * @generated from message postpilot.v1.StageLevel
 */
export type StageLevel = Message<"postpilot.v1.StageLevel"> & {
  /**
...
/**
 * Describes the message postpilot.v1.StageLevel.
