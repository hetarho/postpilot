...
describe('assignmentFailureMessage', () => {
  it('translates a stable purpose refusal and hides backend prose', () => {
    expect(assignmentFailureMessage(connectAppError('PURPOSE_NOT_FOUND', Code.NotFound))).toBe(
      '고른 용도를 찾을 수 없어요. 목록을 새로 고친 뒤 다시 시도해 주세요. 용도를 찾을 수 없어요.',
    )
  })
