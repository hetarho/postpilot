...
import { remainingChars } from '@/entities/template'
import {
  Button,
  Editable,
  FieldLabel,
...
/** One read-first field of a template (design-language: read first, edit on request).
 *
...
export function EditableTemplateField({
  label,
  value,
  limit,
  multiline = false,
